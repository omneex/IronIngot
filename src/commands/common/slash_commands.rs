...
#[allow(dead_code)]
pub fn get_number(option_value: CommandDataOptionValue) -> Option<f64> {
...
#[allow(dead_code)]
pub fn get_role(option_value: CommandDataOptionValue) -> Option<Role> {
...
#[allow(dead_code)]
pub fn get_bool(option_value: CommandDataOptionValue) -> Option<bool> {
